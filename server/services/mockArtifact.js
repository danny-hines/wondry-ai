...
const LIBRARY = {
  rock: {
    color: '#b45309', emoji: '🪨', title: 'The Rock Cycle',
    intro: "Rocks are always changing — it just happens SO slowly we can't see it! Let's follow a rock on its big adventure.",
    cards: [
      ['Igneous', '🌋', 'Born from hot, melted rock called magma. When it cools, it turns solid!'],
      ['Sedimentary', '🏖️', 'Made from tiny bits of sand and shells squished together over a long, long time.'],
      ['Metamorphic', '💎', 'Changed by heat and squeezing deep underground into something brand new.'],
    ],
    facts: ['A rock can take MILLIONS of years to change.', 'Diamonds are rocks made deep inside the Earth!', 'Some beaches are made of crushed-up rock and shells.'],
    quiz: { q: 'Which rock is born from a volcano?', a: ['Igneous', 'Sedimentary', 'Metamorphic'], correct: 0 },
  },
  space: {
    color: '#4338ca', emoji: '🚀', title: 'A Trip Through Space',
    ...
    cards: [
      ...
      ['The Moon', '🌙', "Earth's rocky neighbor. It has no air, and astronauts have walked on it!"],
      ['The Stars', '⭐', 'Other suns, so far away they look like tiny sparkles at night.'],
    ],
    facts: ['The Sun is so big that one million Earths could fit inside!', 'It takes 8 minutes for sunlight to reach us.', 'There is no sound in space.'],
    quiz: { q: 'What is the Moon made of?', a: ['Cheese', 'Rock', 'Water'], correct: 1 },
  },
  count: {
    color: '#0d9488', emoji: '🔢', title: "Let's Count Together!",
    ...
    facts: ['Zero means "nothing at all".', 'You have ten fingers — perfect for counting!', 'A dozen means twelve.'],
    quiz: { q: 'What comes after the number 4?', a: ['6', '5', '2'], correct: 1 },
  },
  pig: {
    color: '#db2777', emoji: '🐷', title: 'The Three Little Pigs',
    intro: 'Once upon a time, three little pigs left home to build houses of their very own.',
    cards: [
      ['House of Straw', '🌾', 'The first pig built fast with straw. But the wolf huffed and puffed it down!'],
      ['House of Sticks', '🪵', 'The second pig used sticks. The wolf blew that one over too!'],
      ['House of Bricks', '🧱', 'The third pig worked hard with bricks. The wolf could NOT blow it down!'],
    ],
    facts: ['Working hard pays off — just like the brick house!', 'Bricks are made from baked clay.', 'The story teaches us to be prepared.'],
    quiz: { q: 'Which house did the wolf fail to blow down?', a: ['Straw', 'Sticks', 'Bricks'], correct: 2 },
  },
  ocean: {
    color: '#0284c7', emoji: '🌊', title: 'Under the Ocean',
    ...
    facts: ['The ocean covers most of our planet.', 'Octopuses have three hearts!', 'Some parts of the ocean are deeper than mountains are tall.'],
...
function genericContent(topic) {
  ...
  return {
    color: '#8b5cf6', emoji: pickEmoji(topic), title: t,
    ...
    facts: [`${t} is full of surprises.`, 'Asking questions is how we learn!', 'You can always explore more.'],
    quiz: { q: `Is learning about ${topic} fun?`, a: ['Yes!', 'Yes, a lot!', 'Absolutely!'], correct: 0 },
  };
}
...
export function mockReadingLesson({ profile, interests, level = 2 }) {
  ...
  return { title: `${titleCase(theme).slice(0, 36)} Story`, emoji: pickEmoji(theme), interest: theme, level, pages };
}
...
export function mockFlashcardsDoc({ topic }) {
  ...
  const T = titleCase(t);
  const cards = [
    { front: `What is ${t}?`, back: `${T} is something fun and interesting to learn about!`, hint: 'Think about what you already know.' },
    { front: `A cool fact about ${t}`, back: `There are lots of surprising things to discover about ${t}.` },
  ...
  return {
    title: `${T} Flashcards`, emoji: pickEmoji(t), subject: t,
    blocks: [
      { type: 'text', text: `Let's study ${t} with some flashcards! Tap a card to flip it.` },
      { type: 'flashcards', cards },
      { type: 'quiz', question: `Is learning about ${t} fun?`, options: ['Yes!', 'Yes, a lot!', 'Absolutely!'], answer: 0 },
    ],
  };
}
...
const SCENES = {
  solar: {
    title: 'Our Solar System', emoji: '🪐', subject: 'the solar system',
    intro: "Welcome to space! Tap the sun or any planet to zoom in and hear all about it.",
    scene: {
      layout: 'orbit',
      center: { label: 'The Sun', emoji: '☀️', blurb: 'The sun is a giant ball of hot, glowing gas at the center of everything.', facts: ['The sun is so big that a million Earths could fit inside it.', 'Its warmth and light reach us from very far away.'] },
      nodes: [
        { label: 'Mercury', emoji: '🌑', size: 0.7, blurb: 'Mercury is the closest planet to the sun and the smallest one.', facts: ['It zips around the sun faster than any other planet.', 'Days are blazing hot and nights are freezing cold.'] },
        { label: 'Venus', emoji: '🌕', size: 0.9, blurb: 'Venus is wrapped in thick clouds and is the hottest planet.', facts: ['It shines brightly and is sometimes called the evening star.', 'Its clouds trap heat like a cozy blanket.'] },
        { label: 'Earth', emoji: '🌍', size: 1, blurb: 'Earth is our home, the blue planet covered in water and life.', facts: ['It is the only planet we know of with living things.', 'Most of Earth is covered by big blue oceans.'] },
        { label: 'Mars', emoji: '🔴', size: 0.8, blurb: 'Mars is the dusty red planet that explorers love to study.', facts: ['Its red color comes from rusty iron in the soil.', 'Robots called rovers drive around exploring it.'] },
        { label: 'Jupiter', emoji: '🪐', size: 1.6, blurb: 'Jupiter is the biggest planet of all, a giant ball of swirling gas.', facts: ['It has a huge storm bigger than our whole planet.', 'Many little moons circle around it.'] },
        { label: 'Saturn', emoji: '💫', size: 1.4, blurb: 'Saturn is famous for its beautiful, sparkly rings.', facts: ['Its rings are made of ice and rock.', 'It is so light it could float in a giant bathtub.'] },
      ],
    },
    quiz: { q: 'Which planet is our home?', a: ['Mars', 'Earth', 'Jupiter'], correct: 1 },
  },
  body: {
    title: 'The Human Body', emoji: '🧍', subject: 'the human body',
    intro: 'Your body is amazing! Tap each part to find out the special job it does.',
    scene: {
      layout: 'map', backdrop: 'body',
      nodes: [
        { label: 'Brain', emoji: '🧠', x: 50, y: 9, blurb: 'Your brain is the boss that helps you think, feel, and remember.', facts: ['It tells the rest of your body what to do.', 'It never stops working, even while you sleep.'] },
        { label: 'Heart', emoji: '🫀', x: 44, y: 34, blurb: 'Your heart pumps blood all around your body, day and night.', facts: ['It beats faster when you run and play.', 'It is about the size of your own fist.'],
          icon: { viewBox: '0 0 24 24', shapes: [{ type: 'path', d: 'M12 21 C12 21 4 13.8 4 8.8 C4 6.4 5.9 4.5 8.3 4.5 C9.8 4.5 11.2 5.4 12 6.8 C12.8 5.4 14.2 4.5 15.7 4.5 C18.1 4.5 20 6.4 20 8.8 C20 13.8 12 21 12 21 Z', fill: 'currentColor' }] } },
        { label: 'Lungs', emoji: '🫁', x: 58, y: 34, blurb: 'Your lungs fill with air so you can breathe in and out.', facts: ['You have two lungs, one on each side.', 'They help you blow out birthday candles.'] },
        { label: 'Tummy', emoji: '🍎', x: 50, y: 52, blurb: 'Your tummy turns the food you eat into energy to grow and play.', facts: ['It gets to work right after you swallow.', 'Good food keeps it happy and strong.'] },
        { label: 'Hands', emoji: '✋', x: 18, y: 56, blurb: 'Your hands let you hold, build, wave, and high five.', facts: ['Each hand has five clever fingers.', 'Your thumbs help you grab things tightly.'] },
        { label: 'Feet', emoji: '🦶', x: 58, y: 94, blurb: 'Your feet hold you up so you can walk, run, and jump.', facts: ['They balance your whole body.', 'Wiggling your toes helps you stay steady.'] },
      ],
    },
    quiz: { q: 'Which part pumps blood around your body?', a: ['Brain', 'Heart', 'Feet'], correct: 1 },
  },
  water: {
    title: 'The Water Cycle', emoji: '💧', subject: 'the water cycle',
    intro: 'Water goes on a never-ending journey! Tap each step to follow the loop.',
    scene: {
      layout: 'cycle',
      nodes: [
        { label: 'Evaporation', emoji: '☀️', blurb: 'The warm sun turns water into invisible vapor that floats up into the sky.', facts: ['Water rises up from oceans, lakes, and puddles.', 'You cannot see vapor, but it is there.'] },
        { label: 'Condensation', emoji: '☁️', blurb: 'High up, the vapor cools and gathers together to make fluffy clouds.', facts: ['Tiny drops join up to build a cloud.', 'Clouds are made of billions of water droplets.'] },
        { label: 'Precipitation', emoji: '🌧️', blurb: 'When clouds get heavy, water falls back down as rain or snow.', facts: ['Rain, snow, and hail are all precipitation.', 'This is the water coming back to the ground.'] },
        { label: 'Collection', emoji: '🌊', blurb: 'The water gathers in rivers, lakes, and oceans, ready to start again.', facts: ['Rivers carry water back to the sea.', 'Then the sun warms it and the loop begins anew.'] },
      ],
    },
    quiz: { q: 'What makes water rise into the sky?', a: ['The moon', 'The warm sun', 'The wind'], correct: 1 },
  },
};
function genericScene(topic) {
  const t = titleCase(topic);
  return {
    title: t, emoji: pickEmoji(topic), subject: topic,
    intro: `Let's explore ${topic}! Tap each part to zoom in and hear about it.`,
    scene: {
      layout: 'map',
      nodes: [
        { label: 'Part one', emoji: '🔵', x: 25, y: 30, blurb: `This is one interesting part of ${topic}.`, facts: [`There is a lot to discover about ${topic}.`] },
        { label: 'Part two', emoji: '🟢', x: 70, y: 30, blurb: `Here is another part of ${topic} to explore.`, facts: ['Tap around to learn more!'] },
        { label: 'Part three', emoji: '🟡', x: 30, y: 72, blurb: `${t} has so many pieces that fit together.`, facts: ['Every part has its own special job.'] },
        { label: 'Part four', emoji: '🟣', x: 72, y: 72, blurb: `Exploring ${topic} helps us understand the world.`, facts: ['Asking questions is how we learn!'] },
      ],
    },
    quiz: { q: `Is exploring ${topic} fun?`, a: ['Yes!', 'Yes, a lot!', 'Absolutely!'], correct: 0 },
  };
}
export function mockExplorableDoc({ topic }) {
  ...
  return {
    title: c.title, emoji: c.emoji, subject: c.subject,
    blocks: [
...
const MEMORY_SETS = {
  animals: [['🐶', 'Dog'], ['🐱', 'Cat'], ['🦁', 'Lion'], ['🐯', 'Tiger'], ['🐰', 'Rabbit'], ['🐸', 'Frog'], ['🐼', 'Panda'], ['🦊', 'Fox']],
  space: [['🚀', 'Rocket'], ['🌙', 'Moon'], ['⭐', 'Star'], ['🪐', 'Planet'], ['☄️', 'Comet'], ['🛸', 'UFO'], ['👽', 'Alien'], ['🌍', 'Earth']],
  food: [['🍎', 'Apple'], ['🍌', 'Banana'], ['🍕', 'Pizza'], ['🍓', 'Strawberry'], ['🥕', 'Carrot'], ['🍪', 'Cookie'], ['🧀', 'Cheese'], ['🍩', 'Donut']],
  ocean: [['🐟', 'Fish'], ['🐙', 'Octopus'], ['🐢', 'Turtle'], ['🦀', 'Crab'], ['🐳', 'Whale'], ['🐬', 'Dolphin'], ['🦈', 'Shark'], ['🐚', 'Shell']],
  vehicles: [['🚗', 'Car'], ['🚌', 'Bus'], ['✈️', 'Plane'], ['🚂', 'Train'], ['🚲', 'Bike'], ['🚁', 'Helicopter'], ['🚢', 'Ship'], ['🚒', 'Fire Truck']],
};
...
function renderLesson(c, name) {
  const cards = c.cards.map(([t, e, d], i) => `
  ...
  const opts = c.quiz.a.map((a, i) => `<button class="opt" data-correct="${i === c.quiz.correct}">${a}</button>`).join('');
