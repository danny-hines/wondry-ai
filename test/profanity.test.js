...
test('maskProfanity blanks swears (incl. the whisper mis-transcription that shipped one)', () => {
  ...
  assert.equal(maskProfanity('Yay! Let me make you a page about what the fuck she’s eat!'),
    'Yay! Let me make you a page about what the **** she’s eat!');
  assert.equal(maskProfanity('SHIT and Shitty and fuckin’ awesome'), '**** and **** and **** awesome');
});

test('maskProfanity leaves innocent words alone (whole-word only)', () => {
  // substrings of swears must NOT trigger
  assert.equal(maskProfanity('a class of bass in the grass, please pass'), 'a class of bass in the grass, please pass');
